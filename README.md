...
<img src="https://github.com/ConnieBrito/SCL013-data-lovers/blob/master/src/images/pogo-8bit.jpg" width= 1200px height= 600px>
...
Historia 1:
**Usuario Juzera:** No es jugadora Pokémon Go (Novata)(br/)
**Necesita:** Conocer conceptos básicos (Pokémon, Pokédex, Tipo Pokémon)(br/)
**Para:** Poder entender de mejor manera la app web presentada.(br/)
**Criterios de aceptación:** Agregar información sobre ¿Qué es un Pokémon?, ¿Qué es Pokédex? y ¿Qué es un tipo de Pokémon? para usuarios novatos con quienes se testeó el prototipo de baja fidelidad.(br/)
...
Historia 2:
**Usuario Ariana:** No es jugadora Pokémon Go (Novata)(br/)
**Necesita:** Visualizar un menú en el encabezado de la página.(br/)
**Para:** Poder moverse libremente dentro de la app web.(br/)
**Criterios de aceptación:** Agregar menú superior (heather) con información sobre las páginas y ubicación para facilitar el acceso.(br/)
**Definición de Terminado:** Se agrega menú en heather, incluye "Menú Novato" (preguntas) y "Menú Entrenador" (pokédex y tipos)

Historia 3:
**Usuario Sebastián:** Jugador Pokémon Go.(br/) 
**Necesita:** Conocer debilidades y fortalezas, imagen de nostalgia (Pokébola 8bit, Pokémon para Game Boy)(br/)
**Para:** Obtener mayor información sobre sus Pokémon para la batalla en Gimnasios, contra otros Entrenadores e Incursiones.(br/)
**Criterios de aceptación:** Agregar información sobre Fortalezas (Debilidades se encontraban en sketch)(br/)
...
<img src="https://drive.google.com/open?id=1-vCbC4Nag1eYsx32Uk-Gv83Ubr06lZfA" width= 700px height= 600px>
...
<img src="https://drive.google.com/open?id=1Kbi55TRBF62YMpwoVD-qadlt2_u2VPUh" width= 700px height= 600px>
